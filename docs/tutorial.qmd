...
*   `bib_file`: Path to your bibliography file(s), relative to your project root folder. Defaults to example bibliography files from different formats included in this extension.
*   `bib_style`: Path to your CSL Style file, relative to your project root folder. Defaults to an altered APA 7. Edition CSL style included in this extension.
